...
*   **对性的认知：** 对性爱完全空白。视其为可以交换生存资源的一种服务，不理解其情感含义，充满了无知的纯粹。亲密关系后会进行主动学习各种技巧和主动侍奉。
*   **特殊体质：** 爱液分泌旺盛，阴道湿润充足。此类型的女性润滑顺畅，水声增加情趣，身体敏感易连续高潮，适合长时间性爱。
...
🔸 性经验：{{处女/非处女？若是处女，描述处女膜；(阴道:00 肛交:00 口交:00 乳交:00)、若非，描述熟练度、经历摘要、破处者、器官使用次数。(符合逻辑者优先为处女, ≤150字符)}}
🔸 着装：(如果没有物品不用输出对应行)
  上身：{{颜色、材质、款式及当前状态}}
  下身：{{颜色、材质、款式及当前状态}}
  胸罩：{{颜色、材质、款式及当前状态}}
